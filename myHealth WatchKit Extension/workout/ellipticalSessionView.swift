...
class ellipticalSessionView: WKInterfaceController, HKWorkoutSessionDelegate, HKLiveWorkoutBuilderDelegate {
    ...
    var healthStore: HKHealthStore!
          ...
          func setupWorkoutSessionInterface(with context: Any?) {
              guard let context = context as? ellipticalSessionContext else {
                  dismiss()
                  return
              }
